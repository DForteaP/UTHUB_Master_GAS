...
public:
	...
	UPROPERTY(BlueprintReadOnly, Category = "Attributes | CommonSet") FGameplayAttributeData Burned;
	ATTRIBUTE_ACCESSORS(UCoreAttributeSet, Burned);

	UPROPERTY(BlueprintReadOnly, Category = "Attributes | CommonSet") FGameplayAttributeData Time;
	ATTRIBUTE_ACCESSORS(UCoreAttributeSet, Time);
};
